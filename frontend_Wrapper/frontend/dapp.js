// @TODO: Update this address to match your deployed FintooneyMarket contract!
const contractAddress = "0x95669582a323427D562Ec7476C4392C3e355421a";
...
const dApp = {
  ...
  main: async function() {
    ...
    this.marsJson = await (await fetch("./FintooneyMarket.json")).json();
    this.auctionJson = await (await fetch("./FintooneyAuction.json")).json();
